...
private TextView username,userroll,userroom,userbranch,userbloodgroup;
...
private String image_url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userbloodgroup=findViewById(R.id.user_bloodgrp);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bloodgrp=userbloodgroup.getText().toString();
                checkdetail();
            }
        });
    ...
    private void checkdetail() {
        if(imageuri==null){
            ...
            userbranch.setError("enter branch");
        }else if(bloodgrp.length()==0){
            userbloodgroup.setError("enter blood group");
        }
        else{
